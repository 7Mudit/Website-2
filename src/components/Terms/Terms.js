    ...
    <>
      <div className="termsSection">
        ...
        <div className="termsContent">
          ...
          <p>lease have a survey our Privacy Policy, which is consolidated into these Terms & Conditions of Use furthermore administers your utilization of the Websites. Your utilization of the site is liable to our Privacy Policy. If you don’t mind audit the approach for additional on how we gather and utilize data.</p>
          ...
          <p>In spite of our earnest attempts, once in a while a thing on our list may not be accessible, the offer might have been misquoted, or a thing might be mispriced. For any of these reasons, we might scratch off your request or we might get in touch with you for directions on the request.</p>

          <h2>Paying for Your Order</h2>

          <p>For the most part, we’ll charge your card for a thing when we transport the product to you or affirm its accessibility in-store. Be that as it may, we might pre-approve your order some with your credit or platinum card backer at the time you submit the request, which might affect your accessible credit line. When you pre-order with a debit card, we’ll charge your card when you put the pre-order.</p>

          <p>For digital items, we’ll charge your card when you affirm a conveyance time. For advanced things, we’ll charge your card when you start the download of the item or the item is put in your record and accessible for use.</p>

          <h2>Order Confirmation</h2>
          <p>Our request affirmation to you doesn’t connote our acknowledgment of your request, nor does it constitute affirmation of our offer to offer. Whenever after receipt of your request, we might acknowledge, decrease, or place amount or different points of confinement on your request for any reason.</p>
          <p>We might force these limits on every individual, per-family unit, per-request, or some other premise. On the off chance that we reject, limit, or generally alter your request, we will endeavor to inform you utilizing the email address you give to us.</p>
          <p>In the event that we wipe out a request or part of a request that we’ve effectively charged you for, we’ll discount you everything of the crossed out segment of the request.</p>
